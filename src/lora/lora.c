...
#define CONFIG_RST_GPIO GPIO_NUM_35
#define CONFIG_MISO_GPIO GPIO_NUM_13  // THIS SHOULD BE 25, but not available on ESP32-S2
#define CONFIG_MOSI_GPIO GPIO_NUM_26
#define CONFIG_SCK_GPIO GPIO_NUM_33
